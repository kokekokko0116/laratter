...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.item icon="list-bullet" :href="route('tweets.index')"
                :current="request()->routeIs('tweets.index')" wire:navigate>
                {{ __('Tweet一覧') }}
            </flux:navlist.item>
            <flux:navlist.item icon="pencil-square" :href="route('tweets.create')"
